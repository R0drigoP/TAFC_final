	...
	#running executable and waiting
		...
		if current < fit:
			...
			if current < best_overall:
				shutil.copy(source_bs,best_bs)
				shutil.copy(source_mv,best_mv)
...
study.enqueue_trial({'N_molecules': 1000, 
	'survival_rate': 0.95, 
	'mutation_prob': 0.01, 
	'm0': 0.5, 
	'L_box': 2.})
...
study.enqueue_trial({
	'N_molecules':1416,
	'survival_rate':0.8521488803019164,
	'mutation_prob':0.08389631145270428,
	'm0':0.5980820533442097,
	'L_box':2.07359114610073
	})
